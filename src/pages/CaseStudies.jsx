  ...
  return (
    <main className="pb-32 pt-24">
      <header className="mb-24 mt-12 text-center max-w-7xl mx-auto px-8">
        ...
        >
            <span className="font-label text-[10px] text-primary uppercase tracking-[0.4em] font-bold mb-6 block">Our Portfolio</span>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tighter text-white mb-8">Architectural <span className="italic-highlight">Victories.</span></h1>
      ...
      <section className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        {projects.map((p, i) => (
            ...
            >
                ...
                <div className="p-8">
                    <span className="text-primary font-label text-[9px] uppercase tracking-widest font-bold block mb-4">{p.cat}</span>
                    <h3 className="text-xl font-bold text-white mb-2">{p.title}</h3>
                    <div className="flex justify-between items-center mt-6">
                        <span className="italic-highlight text-lg">{p.stats}</span>
